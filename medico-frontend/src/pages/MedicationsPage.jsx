      ...
      {showFilters && (
        <div className="page-section" style={{ marginBottom: "20px", padding: "16px", background: "var(--hp-bg-soft, #334155)", borderRadius: "12px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "flex-end" }}>
            <div>
              <label style={{ display: "block", fontSize: "12px", marginBottom: "4px", color: "var(--hp-text-soft)" }}>Prescribed Date From</label>
              <input type="date" value={dateFrom} onChange={(e) => { setDateFrom(e.target.value); setPage(0); }}
                style={{ padding: "8px", borderRadius: "6px", border: "1px solid #555", background: "#1e293b", color: "#fff" }} />
            </div>
            <div>
              <label style={{ display: "block", fontSize: "12px", marginBottom: "4px", color: "var(--hp-text-soft)" }}>Prescribed Date To</label>
              <input type="date" value={dateTo} onChange={(e) => { setDateTo(e.target.value); setPage(0); }}
                style={{ padding: "8px", borderRadius: "6px", border: "1px solid #555", background: "#1e293b", color: "#fff" }} />
            </div>
            <div>
              <label style={{ display: "block", fontSize: "12px", marginBottom: "4px", color: "var(--hp-text-soft)" }}>Route</label>
            ...
            <button className="hp-secondary-btn" onClick={() => { setDateFrom(""); setDateTo(""); setRouteFilter(""); setSearchTerm(""); setPage(0); }}>
              Clear Filters
            </button>
          </div>
        </div>
        ...
        <div className="page-section page-form">
          ...
          <form className="form-grid" onSubmit={handleAddMedication}>
            <label>
              Encounter
              <AsyncSelect
                value={newMedication.encounter_id}
            ...
            <label>
              ...
              <AsyncSelect
                ...
                onChange={(value) => handleFKChange('prescriber_id', value)}
