    ...
    <div className="hp-root">
      ...
      <div className="hp-main">
          <header className="hp-header">
            <div>
              <h1 className="hp-header-title">Medications</h1>
              <p className="hp-header-subtitle">Review medication history, prescribed dosages and prescriber information.</p>
            </div>
                ...
                <div className="hp-table-container">
                  <div style={{ overflowX: "auto" }}>
                    <table className="hp-table">
                      <thead>
                        <tr>
                          <th style={{ cursor: "pointer" }} onClick={() => handleSort("medication_id")}>
                            DRUG NAME {sortBy === "medication_id" && (sortDirection === "asc" ? "↑" : "↓")}
                          </th>
                          <th>DOSAGE</th>
                          <th>ROUTE</th>
                          <th>PRESCRIBER</th>
                          <th style={{ cursor: "pointer" }} onClick={() => handleSort("prescribed_date")}>
                            DATE {sortBy === "prescribed_date" && (sortDirection === "asc" ? "↑" : "↓")}
                          </th>
                          <th>PATIENT</th>
                            ...
                            <tr key={medication.medication_id}>
                              ...
                              <td>
                                {medication.prescriber_id ? (
                                  <Link to={`/providers/${medication.prescriber_id}`} style={{ color: "var(--hp-primary)", textDecoration: "none" }}>
                              ...
                              <td>{medication.prescribed_date ? new Date(medication.prescribed_date).toLocaleDateString('en-GB') : "-"}</td>
                              <td>
                                <Link to={`/patients/${medication.patient_id}`} style={{ color: "var(--hp-primary)", textDecoration: "none" }}>
